...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/data-sources/secret_v1
...
export class DataKubernetesSecretV1 extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKubernetesSecretV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/data-sources/secret_v1#import import section} in the documentation of this resource for the id to use
