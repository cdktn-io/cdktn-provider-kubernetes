...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/data-sources/secret_v1
...
export interface DataKubernetesSecretV1Config extends cdktn.TerraformMetaArguments {
  /**
...
export class DataKubernetesSecretV1MetadataOutputReference extends cdktn.ComplexObject {
...
*/
export class DataKubernetesSecretV1 extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKubernetesSecretV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/data-sources/secret_v1#import import section} in the documentation of this resource for the id to use
