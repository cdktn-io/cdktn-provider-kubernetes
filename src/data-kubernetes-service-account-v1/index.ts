...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/data-sources/service_account_v1
...
export class DataKubernetesServiceAccountV1ImagePullSecretOutputReference extends cdktn.ComplexObject {
...
export class DataKubernetesServiceAccountV1ImagePullSecretList extends cdktn.ComplexList {
...
export class DataKubernetesServiceAccountV1SecretOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class DataKubernetesServiceAccountV1SecretList extends cdktn.ComplexList {
...
export class DataKubernetesServiceAccountV1MetadataOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
*/
export class DataKubernetesServiceAccountV1 extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKubernetesServiceAccountV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/data-sources/service_account_v1#import import section} in the documentation of this resource for the id to use
