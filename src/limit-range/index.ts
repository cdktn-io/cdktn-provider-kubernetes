...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/resources/limit_range
...
export interface LimitRangeConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class LimitRangeMetadataOutputReference extends cdktn.ComplexObject {
...
export function limitRangeSpecLimitToTerraform(struct?: LimitRangeSpecLimit | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function limitRangeSpecLimitToHclTerraform(struct?: LimitRangeSpecLimit | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class LimitRangeSpecLimitOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): LimitRangeSpecLimit | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: LimitRangeSpecLimit | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class LimitRangeSpecLimitList extends cdktn.ComplexList {
  public internalValue? : LimitRangeSpecLimit[] | cdktn.IResolvable
...
export interface LimitRangeSpec {
  ...
  */
  readonly limit?: LimitRangeSpecLimit[] | cdktn.IResolvable;
}
...
export function limitRangeSpecToTerraform(struct?: LimitRangeSpecOutputReference | LimitRangeSpec): any {
  ...
  return {
    limit: cdktn.listMapper(limitRangeSpecLimitToTerraform, true)(struct!.limit),
  }
}
...
export function limitRangeSpecToHclTerraform(struct?: LimitRangeSpecOutputReference | LimitRangeSpec): any {
  ...
  const attrs = {
    limit: {
      value: cdktn.listMapperHcl(limitRangeSpecLimitToHclTerraform, true)(struct!.limit),
      isBlock: true,
      type: "list",
...
export class LimitRangeSpecOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public putLimit(value: LimitRangeSpecLimit[] | cdktn.IResolvable) {
...
*/
export class LimitRange extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LimitRange that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/resources/limit_range#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the LimitRange to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "kubernetes_limit_range", importId: importFromId, provider });
      }
