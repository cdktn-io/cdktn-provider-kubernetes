...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/resources/namespace_v1
...
export class NamespaceV1TimeoutsOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): NamespaceV1Timeouts | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: NamespaceV1Timeouts | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class NamespaceV1 extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NamespaceV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/resources/namespace_v1#import import section} in the documentation of this resource for the id to use
