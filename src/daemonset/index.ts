...
export class Daemonset extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Daemonset that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/daemonset#import import section} in the documentation of this resource for the id to use
