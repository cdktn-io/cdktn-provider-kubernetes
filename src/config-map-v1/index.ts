...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/resources/config_map_v1
...
export interface ConfigMapV1Config extends cdktn.TerraformMetaArguments {
  /**
...
export class ConfigMapV1MetadataOutputReference extends cdktn.ComplexObject {
...
*/
export class ConfigMapV1 extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigMapV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/resources/config_map_v1#import import section} in the documentation of this resource for the id to use
