...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/resources/role
...
export interface RoleConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  readonly rule: RoleRule[] | cdktn.IResolvable;
}
...
export class RoleMetadataOutputReference extends cdktn.ComplexObject {
...
export function roleRuleToTerraform(struct?: RoleRule | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export function roleRuleToHclTerraform(struct?: RoleRule | cdktn.IResolvable): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdktn.io/docs/concepts/resources#references");
  }
...
export class RoleRuleOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): RoleRule | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: RoleRule | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
  ...
  public get apiGroups() {
    return cdktn.Fn.tolist(this.getListAttribute('api_groups'));
  }
  ...
  public get resourceNames() {
    return cdktn.Fn.tolist(this.getListAttribute('resource_names'));
  }
  ...
  public get verbs() {
    return cdktn.Fn.tolist(this.getListAttribute('verbs'));
  }
...
export class RoleRuleList extends cdktn.ComplexList {
  public internalValue? : RoleRule[] | cdktn.IResolvable
...
export class Role extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Role that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/resources/role#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Role to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "kubernetes_role", importId: importFromId, provider });
      }
  ...
  */
  ...
  public putRule(value: RoleRule[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      rule: cdktn.listMapper(roleRuleToTerraform, true)(this._rule.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      rule: {
        value: cdktn.listMapperHcl(roleRuleToHclTerraform, true)(this._rule.internalValue),
        isBlock: true,
        type: "list",
