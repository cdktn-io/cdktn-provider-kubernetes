...
DataKubernetesPodV1MetadataOutputReference} from './index-structs/index';
export * from './index-structs/index';
import { Construct } from 'constructs';
import * as cdktn from 'cdktn';
export interface DataKubernetesPodV1Config extends cdktn.TerraformMetaArguments {
  /**
...
*/
export class DataKubernetesPodV1 extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKubernetesPodV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/data-sources/pod_v1#import import section} in the documentation of this resource for the id to use
