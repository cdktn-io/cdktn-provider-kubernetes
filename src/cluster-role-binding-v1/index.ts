...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/cluster_role_binding_v1
...
export interface ClusterRoleBindingV1Config extends cdktn.TerraformMetaArguments {
  /**
  ...
  */
  readonly subject: ClusterRoleBindingV1Subject[] | cdktn.IResolvable;
}
...
export class ClusterRoleBindingV1MetadataOutputReference extends cdktn.ComplexObject {
...
export class ClusterRoleBindingV1RoleRefOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
export class ClusterRoleBindingV1SubjectOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): ClusterRoleBindingV1Subject | cdktn.IResolvable | undefined {
  ...
  public set internalValue(value: ClusterRoleBindingV1Subject | cdktn.IResolvable | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
...
export class ClusterRoleBindingV1SubjectList extends cdktn.ComplexList {
  public internalValue? : ClusterRoleBindingV1Subject[] | cdktn.IResolvable
...
*/
export class ClusterRoleBindingV1 extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ClusterRoleBindingV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/cluster_role_binding_v1#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "kubernetes_cluster_role_binding_v1", importId: importFromId, provider });
      }
  ...
  */
  ...
  public putSubject(value: ClusterRoleBindingV1Subject[] | cdktn.IResolvable) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      subject: cdktn.listMapper(clusterRoleBindingV1SubjectToTerraform, true)(this._subject.internalValue),
    };
  }
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      subject: {
        value: cdktn.listMapperHcl(clusterRoleBindingV1SubjectToHclTerraform, true)(this._subject.internalValue),
        isBlock: true,
        type: "list",
