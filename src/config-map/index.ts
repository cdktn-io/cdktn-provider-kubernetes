...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/resources/config_map
...
export interface ConfigMapConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class ConfigMapMetadataOutputReference extends cdktn.ComplexObject {
...
*/
export class ConfigMap extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/resources/config_map#import import section} in the documentation of this resource for the id to use
