...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs
...
export class KubernetesProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing KubernetesProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs#import import section} in the documentation of this resource for the id to use
