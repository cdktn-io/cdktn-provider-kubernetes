...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/data-sources/config_map
...
export interface DataKubernetesConfigMapConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataKubernetesConfigMapMetadataOutputReference extends cdktn.ComplexObject {
...
*/
export class DataKubernetesConfigMap extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKubernetesConfigMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/data-sources/config_map#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "kubernetes_config_map", importId: importFromId, provider });
      }
