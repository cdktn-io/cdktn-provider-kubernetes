...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/data-sources/config_map
...
export class DataKubernetesConfigMap extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKubernetesConfigMap that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/data-sources/config_map#import import section} in the documentation of this resource for the id to use
