...
export * as validatingAdmissionPolicyV1 from './validating-admission-policy-v1';
...
export * as dataKubernetesEndpointSliceV1 from './data-kubernetes-endpoint-slice-v1';
