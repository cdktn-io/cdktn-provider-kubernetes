...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/config_map_v1_data
...
export interface ConfigMapV1DataConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class ConfigMapV1DataMetadataOutputReference extends cdktn.ComplexObject {
...
*/
export class ConfigMapV1Data extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ConfigMapV1Data that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.1/docs/resources/config_map_v1_data#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the ConfigMapV1Data to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "kubernetes_config_map_v1_data", importId: importFromId, provider });
      }
