...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/data-sources/namespace
...
export interface DataKubernetesNamespaceConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class DataKubernetesNamespaceSpecOutputReference extends cdktn.ComplexObject {
...
export class DataKubernetesNamespaceSpecList extends cdktn.ComplexList {
...
export class DataKubernetesNamespaceMetadataOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
*/
export class DataKubernetesNamespace extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataKubernetesNamespace that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/data-sources/namespace#import import section} in the documentation of this resource for the id to use
