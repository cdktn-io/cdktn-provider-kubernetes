...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/resources/horizontal_pod_autoscaler_v1
...
export class HorizontalPodAutoscalerV1 extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing HorizontalPodAutoscalerV1 that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/resources/horizontal_pod_autoscaler_v1#import import section} in the documentation of this resource for the id to use
