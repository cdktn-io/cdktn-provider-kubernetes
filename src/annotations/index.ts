...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/resources/annotations
...
export interface AnnotationsConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class AnnotationsMetadataOutputReference extends cdktn.ComplexObject {
...
*/
export class Annotations extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Annotations that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.1.0/docs/resources/annotations#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the Annotations to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "kubernetes_annotations", importId: importFromId, provider });
      }
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      template_annotations: cdktn.hashMapper(cdktn.stringToTerraform)(this._templateAnnotations),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      template_annotations: {
        value: cdktn.hashMapperHcl(cdktn.stringToHclTerraform)(this._templateAnnotations),
        isBlock: false,
        type: "map",
        storageClassType: "stringMap",
      },
