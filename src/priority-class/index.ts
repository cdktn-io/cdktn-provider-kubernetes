...
// https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/resources/priority_class
...
export interface PriorityClassConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class PriorityClassMetadataOutputReference extends cdktn.ComplexObject {
...
*/
export class PriorityClass extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing PriorityClass that should be imported. Refer to the {@link https://registry.terraform.io/providers/hashicorp/kubernetes/3.2.0/docs/resources/priority_class#import import section} in the documentation of this resource for the id to use
  * @param provider? Optional instance of the provider where the PriorityClass to import is found
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "kubernetes_priority_class", importId: importFromId, provider });
      }
