...
```go
import "github.com/cdktn-io/cdktn-provider-kubernetes-go/kubernetes/v12/manifest"
...
&manifest.ManifestConfig {
	...
	FieldManager: github.com/cdktn-io/cdktn-provider-kubernetes-go/kubernetes/v12.manifest.ManifestFieldManager,
	Object: *map[string]interface{},
	Timeouts: github.com/cdktn-io/cdktn-provider-kubernetes-go/kubernetes/v12.manifest.ManifestTimeouts,
	Wait: github.com/cdktn-io/cdktn-provider-kubernetes-go/kubernetes/v12.manifest.ManifestWait,
	WaitFor: github.com/cdktn-io/cdktn-provider-kubernetes-go/kubernetes/v12.manifest.ManifestWaitFor,
}
```
